...
UserPhraseData *UserGetPhraseNext(ChewingData *pgdata, const uint16_t phoneSeq[])
{
    ...
    pgdata->userphraseData.phoneSeq = (uint16_t *) phoneSeq;

    pgdata->userphraseData.recentTime =
